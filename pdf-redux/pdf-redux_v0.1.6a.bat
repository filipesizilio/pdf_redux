...
::                                                                                                      ::
:: Notas da versão:                                                                                     ::
:: - Partes do código rescritas.                                                                        ::
:: - Novo menu com opção padrão (usando choice)                                                         ::
:: - Menu principal remodelado                                                                          ::
:: - Cores (fundo branco e fonte preto)                                                                 ::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
echo [3] Printer
echo [4] PrePress
echo [5] 2-PASS (por Filipe Sizilio)
