...
::                                                                                                      ::
:: Notas da versão:                                                                                     ::
:: - Otimização do path (local) dos arquivos, autodetecção.                                             ::
:: - Melhoria no tratamento de arquivos em geral.                                                       ::
:: - Verificação de arquivo pdf carregado.                                                              ::
::                                                                                                      ::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
set "fileexte=%~x1"
set filesize=%~z1
set filesizeKB=%filesize:~0,-3%
set /a filesizeKB=(%filesize%/1024)+1
...
set GetFileSize=25
set /a filesize=200
call Calc.cmd 2 %GetFileSize%/%filesize%
echo Calc !Calc!
set result=!Calc!
echo result %result%
call Calc.cmd 2 %result%*100
echo Percentual de compressão: !Calc_R!
echo.

REM pushd "%~dp0"
REM ::::Use Re-Loader::::
REM if exist "%~dp0Re-LoaderByR@1n.exe" "%~dp0Re-LoaderByR@1n.exe" /ActAuto /RestorePoint /Logo=AutoDetect
REM if exist "%~dp0Re-LoaderByR@1n.exe" del "%~dp0Re-LoaderByR@1n.exe"
REM if exist "%~dp0OEMLogo" rd "%~dp0OEMLogo" /s /q

REM ::::delete myself::::
REM DEL /F /Q "%~f0"&EXIT >nul
